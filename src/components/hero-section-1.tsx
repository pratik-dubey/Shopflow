                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Introducing <span className='text-bold text-[#1096D6]'>Shopflow</span> powered by Tambo-AI</span>
                                    ...
                                    <h1
                                        ...
                                        Shopflow for all your pre-purchase researchs
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                        Generative Rendering UI for all your product queries in real time 
                                    </p>
                                </AnimatedGroup>
                    ...
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full justify-between lg:w-auto">
                            <Link
                                ...
                                {/* <Logo /> */}
                                <span className='font-extrabold text-xl text-[#1096D6]'>Shopflow</span>
                            </Link>
